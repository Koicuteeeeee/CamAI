...
*   **Đăng ký:** Sử dụng quy trình **Continuous Multi-angle Enrollment (V2)**. Người dùng chỉ cần quay mặt chậm trước camera, AI sẽ tự động thu nạp 5-10 góc độ khác nhau để đảm bảo xác thực chính xác khi người dùng đứng ở bất kỳ vị trí nào để điều khiển thiết bị.
